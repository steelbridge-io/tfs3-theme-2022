      ...
      <div class="center-content-flex template-header-content">
        <div class="basicpagelogo signature-header template-class text-center">
          <dl class="landing-hd">
            ...
            <?php if(!empty($basic_page_description_new)) {
              echo '<dd class="dd-3"><p class="template-description">' . $basic_page_description_new . '</p></dd>'; }?>
    ...
    <div class="container">
      <div id="primary" class="content-area row">
        <main id="main" class="site-main col-md-8" role="main">
          ...
          <?php
          // Call To Action
          if(!empty($blog_cta_title_new )) :?>
          <!-- CALL TO ACTION ROW -->
          <section id="blog-cta">
            <div class="blog wrapper style4">
              <div class="inner">
                <header class="text-center">
                  <h2><?php echo $blog_cta_title_new;?></h2>
                </header>
                <div class="blog-cta-content"><?php echo do_shortcode($blog_cta_content_new); ?></div>
              </div>
            </div>
          </section>
        ...
        <?php if(is_singular('lower48blog')) { ?>
          <div class="col-md-4">
            <?php get_sidebar('lower48'); ?>
          </div>
        <?php } else { ?>
        <div class="col-md-4">
          <?php get_sidebar(); ?>
