...
get_header(); ?>
  ...
  <div id="primary" class="content-area" style="position: relative;">
    <div id="main" role="main">
      ...
      <!-- top blog reference -->
        <div id="travel-feed-fp-top" class="container-fluid mb-1618">
          <div class="row">
            <div class="newscta" id="news-cta">
              <div data-aos="fade-up" class="news-section">
                <div style="padding-top:1.1rem;">
                  <h2>Latest Travel News - The Fly Shop</h2>
                  <?php
                  $args = array( 'post_type' => 'travel-blog', 'post_status' => 'publish', 'posts_per_page' => 2 );
      ...
      <!-- ==== GRID SECTION ==== -->
      <div class="pt-1618 container-fluid travelblog_bg_color">
        
        <div class="row">
          <div class="col-md-4">
            <div class="thumbnail travelblog-text-color">
              ...
              <section id="" class="widget-section">
                <div class="travel-caption caption">
        ...
        <div id="travel-blog" class="blog-well well">
          <?php $travelblog_title = get_theme_mod('travelblog_title'); ?>
          <h2 class="travelBlogtitle"><?php echo $travelblog_title ?></h2>
          <div class="row center-it">
            <?php
            $args = array( 'post_type' => 'travel-blog', 'post_status' => 'publish', 'posts_per_page' => 4 );
            $loop = new WP_Query($args);
            while ( $loop->have_posts() ) : $loop->the_post();
              echo '<div class="col-md-6 mx-auto"><div class="inner-wrap">';
              the_title('<a class="post-permalink" href="'. get_permalink() .'"><h3>', '</h3></a>');
